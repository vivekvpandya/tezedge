...
fn get_ops_for_block() -> Result<(), Error> {
 ...
 let ops = get_operations_for_block(&bh);
...
fn get_peer_message_response() -> Result<(), Error> {
    ...
    println!("{:?}", wrong_message);
        // let wrong2 = hex::decode("")?;
    // let wrong_message2 = peer_message_response(&wrong2);
    // println!("{:?}", wrong_message2);
    Ok(())
}
...
println!("{:?}" , pmessage);
        let b = hex::decode("000000660061b12238a7c3577d725939970800ade6b82d94a231e855b46af46c37850dd0245203")?;
        let d = dynamic(&b);
        println!("{:?}", d);
        let b1 = hex::decode("b12238a7c3577d725939970800ade6b82d94a231e855b46af46c37850dd02452030ffe7601035ca2892f983c10203656479cfd2f8a4ea656f300cd9d68f74aa625870f7c09f7c4d76ace86e1a7e1c7dc0a0c7edcaa8b284949320081131976a87760c300")?;
let e = operation_for_blocks_message(&b1);
println!("{:?}" , e);
...
fn get_operations_for_blocks_left() -> Result<(), Error> {
    ...
    // let b = hex::decode("")?;
let pmessage = peer_message_response(&message_bytes).unwrap().1;
println!("{:?}" , pmessage);
// let ops = operation_for_blocks_message1(&b);
// println!("{:?}", ops);
// Ok(())
    assert_eq!(1, pmessage.messages().len());
...
let ops = operations(&b);
println!("{:?}", ops);
// let bo = hex::decode("8a7912f9de23a446748861d2667ffa3b4463ed236689492c74703cef598e6f3f0000002eb6d1852a1f397619b16f08121fb01d43a9bf4ded283ab0d96fd114028251690506a7ec514f0b297b6cdc8ff54a658f27f7635d201c61479cd48007c0096752fb0c")?;
// let o = operation(&bo);
// println!("{:?}", o);
Ok(())
}
